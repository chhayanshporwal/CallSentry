package com.safeguard.presentation.common
...
fun Modifier.simpleVerticalScrollbar(
        ...
        return drawWithContent {
                ...
                val needDrawScrollbar = state.layoutInfo.totalItemsCount > 4
                ...
                if (needDrawScrollbar && alpha > 0f) {
                        ...
                        drawRect(
                                ...
                                topLeft =
                                        Offset(
                                                size.width - width.toPx() - padding.toPx(),
                                                scrollbarOffsetY
                                        ),
...
fun Modifier.simpleVerticalScrollbar(
        ...
        return drawWithContent {
                ...
                if (needDrawScrollbar && alpha > 0f) {
                        ...
                        val scrollbarOffsetY = state.value * (viewportHeight / totalContentHeight)
